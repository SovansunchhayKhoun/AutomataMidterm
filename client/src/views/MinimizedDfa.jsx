            ...
            <div className="flex flex-col gap-1">
              <input
                ...
                onChange={(event) => {
                  ...
                  setTransitionTable(Array.from({length: event.target.value},()=> Array.from({length: alphabets.length}, () => 'q0')))
                }}
            ...
            <div>
              <input
                ...
                onChange={(event) => {
                  ...
                  setTransitionTable(Array.from({length: states.length},()=> Array.from({length: event.target.value}, () => 'q0')))
                }}
                max="5"
                className="border-2 border-[#3B82F6] px-2 py-1 w-full"
                type="number"
